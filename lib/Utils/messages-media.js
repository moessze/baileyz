...
export const downloadContentFromMessage = async ({ mediaKey, directPath }, type, opts = {}) => {
    const downloadUrl = directPath ? getUrlFromDirectPath(directPath, opts.host ?? DEF_MEDIA_HOST) : undefined;
    if (!downloadUrl) {
