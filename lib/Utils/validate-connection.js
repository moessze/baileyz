...
const isDesktop = (config) => config.browser[1] === 'Desktop'
...
const getWebInfo = (config) => {
    ...
    // WA accepts full-history Desktop pairing only with the native web sub-platforms.
	 if (config.syncFullHistory && PLATFORM_MAP[config.browser[0]] && isDesktop(config)) {
