...
/**
 * Memaksa pengambilan PreKey baru dari server untuk JID tertentu
 * dan menyimpannya ke SignalRepository/Store.
 */
export async function fetchAndSaveNewPreKey(jid, sock) {
    const { query, signalRepository } = sock;
    ...
    // Proses hasil IQ query untuk menyimpan prekey ke repository
