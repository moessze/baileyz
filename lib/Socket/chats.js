...
export const makeChatsSocket = (config) => {
    ...
    let privacySettings;/** Server-assigned AB props for protocol behavior. Defaults true (safe fallback). */
	 const serverProps = {
    ...
    const fetchBlocklist = async () => {
        ...
        return getBinaryNodeChildren(listNode, 'item').map(n => n.attrs.pn_jid);
    };
